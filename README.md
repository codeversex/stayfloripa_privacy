...
### Introduçao  
Nossa política de privacidade ajudará você a entender quais informações coletamos na *StayFloripa*, como a *StayFloripa* as utiliza e quais opções você tem.
*StayFloripa* criou o aplicativo *StayFloripa* como um aplicativo gratuito. Este SERVIÇO é fornecido pela *StayFloripa* sem nenhum custo e deve ser usado como está.
